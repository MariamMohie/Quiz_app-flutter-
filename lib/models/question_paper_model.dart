...
class QuestionPaperModel {
 ...
 QuestionPaperModel.fromJson(Map<String, dynamic> json) :
    ...
    questionCount=json['quistion_count']as int,
     questions =[];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['time_second'] = this.timeSeconds;
...
class Questions {
  ...
  Questions({ required this.id, required this.question,required this.answers, this.correctAnswer});
   //! the : in function help the body that need to be initialized b4 the body of constructor
